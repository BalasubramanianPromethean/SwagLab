...
public class ClassThree {
	...
	public void launch_browser() {
		...
		extent.createTest("launch browser and website").assignAuthor("Bala").assignCategory("smoke test")
				.assignDevice("chrome").log(Status.PASS, "This is a logging event for MyFirstTest, and it passed!");
	...
	public void regression() throws InterruptedException {
		...
		extent.createTest("verify addtocart page").assignAuthor("BALA").assignCategory("GENERAL test")
				.assignDevice("Chrome").log(Status.INFO, "sucessfully navigated to url and eneterd into login page ");
		 ...
		 * ele ment1.getText(); System.out.println(element1);
		 * 
		 */
	...
	public void address_page_info() throws InterruptedException {
		...
		extent.createTest("verify address page details").assignAuthor("Bala").assignCategory("regression test")
				.assignDevice("fire fox")
				.log(Status.INFO, "sucessfully loged in sucessfully and entered into address_page_info() ");
		...
		driver.findElement(By.id("postal-code")).sendKeys("605010");
	...
	public void validation_thank_you_page() throws InterruptedException {
		...
		extent.createTest("verify validation of 6 get methods").assignAuthor("Bala").assignCategory("smoke test")
				.assignDevice("chrome").log(Status.INFO,
		...
		extent.createTest("verify logout").assignAuthor("Bala").assignCategory("smoke test").assignDevice("chrome")
				.log(Status.INFO, "  loged out sucessfully and enterd into close_browser()page");
	...
	public void close_browser() {
		...
		extent.createTest("verify whether browser is closed").assignAuthor("Bala").assignCategory("smoke test")
				.assignDevice("chrome").log(Status.INFO, "sucessfully close_browser()");
